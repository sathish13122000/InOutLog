    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email.isEmpty()){
                    Toast.makeText(StaffLoginpage.this,"Fields are Empty!",Toast.LENGTH_SHORT).show();
                }
                else if(pwd.isEmpty())
                {
                    Toast.makeText(StaffLoginpage.this,"Fields are Empty!",Toast.LENGTH_SHORT).show();
                ...
                fAuth.signInWithEmailAndPassword(email,pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(StaffLoginpage.this,"Login Successfull",Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(getApplicationContext(),staff.class));
                        }
                        else
                        {
                            Toast.makeText(StaffLoginpage.this,"Login unsccessfull",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
